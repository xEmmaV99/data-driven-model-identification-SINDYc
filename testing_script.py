...
save_path = 'C:/Users/emmav/PycharmProjects/SINDY_project/data/data_files/IMMEC_history_40.0V_' + str(
...
x_dot_test_computed = xdot
# replace en zelf doen iguess?

plt.xlabel("$t$")
plt.ylabel("$\dot{x}$")
plt.plot(t_valid, x_dot_test_predicted)
